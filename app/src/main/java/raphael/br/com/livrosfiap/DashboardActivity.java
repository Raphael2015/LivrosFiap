...
public class DashboardActivity extends AppCompatActivity
    ...
    private void iniciaElementos() {
        ...
        listaVazia = (TextView) findViewById(R.id.mensagem_livros_vazio);
    }
    ...
    private void populaTela() {
        livros = databaseHelper.getLivros();

        exibeRecyclerView(livros.size());
    ...
    private void vaiParaFormulario() {
        Intent form = new Intent(this, formLivroActivity.class);
        startActivity(form);
    }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        menu.setHeaderTitle(livro.getNome());
    ...
    private void editaRestaurante() {
        Intent form = new Intent(this, formLivroActivity.class);
        form.putExtra(Constantes.TAG_LIVRO, livro);
        startActivity(form);
    }

    private void deletaRestaurante() {
        databaseHelper.deletaLivro(livro);
